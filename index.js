...
const generateInvoiceRoutes = require('./routes/generateInvoice'); // Our new invoice routes
...
app.use('/api/billing', generateInvoiceRoutes);    // Invoice generation + retrieval routes
